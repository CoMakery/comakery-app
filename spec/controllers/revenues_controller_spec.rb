...
describe RevenuesController do
  ...
  describe '#create' do
    describe 'owner success' do
      before do
        login account
        get :create, project_id: my_project.id, revenue: { amount: 50 }
      end
    ...
    describe 'owner invalid' do
      before do
        login account
        get :create, project_id: my_project.id, revenue: { amount: '' }
      end
    ...
    describe 'not my project' do
      before do
        login account
        get :create, project_id: other_project.id, revenue: { amount: 50 }
      end
