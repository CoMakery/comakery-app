...
describe AwardsController do
  ...
  describe "#index" do
    it "shows awards for current project" do
      award = create(:award, award_type: create(:award_type, project: project), account: other_account, issuer: issuer)
  ...
  describe "#create" do
    ...
    it "records a award being created" do
      ...
      expect(response).to redirect_to(project_awards_path(project))
