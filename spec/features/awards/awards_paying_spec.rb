...
describe 'awarding users' do
  ...
  let!(:project) do
    stub_token_symbol
    create(:project, title: 'Project that needs awards', account: account, maximum_tokens: 10000000, token: create(:token, ethereum_enabled: true, contract_address: '0x' + '2' * 40, coin_type: 'erc20'))
  end
