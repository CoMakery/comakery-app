...
describe 'awards issuing', js: true do
  ...
  let!(:project1) { create(:sb_project, account: current_auth.account, maximum_tokens: 10, maximum_royalties_per_month: 1, token: create(:token, decimal_places: 8, coin_type: 'erc20')) }
