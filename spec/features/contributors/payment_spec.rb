...
describe 'contributors' do
  let!(:project) { create(:project, title: 'Project that needs awards', payment_type: 'revenue_share', account: account, slack_team_id: 'team id', ethereum_enabled: true, ethereum_contract_address: '0x' + '2' * 40) }
  ...
  describe 'when awards and payments have been issued' do
    before do
      ...
      small_award_type.awards.create_with_quantity(1, issuer: account, authentication: sherman_authentication)
