...
RSpec.describe Blockchain::SyncJob, type: :job do
  let!(:comakery_token) { stub_blockchain_sync && create(:token, _token_type: :comakery_security_token, _blockchain: 'ethereum', contract_address: '0x0000000000000000000000000000000000000000') }
