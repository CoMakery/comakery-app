...
describe('InputField', () => {
    ...
    it('renders correctly with type=select and disabled flag', () => {
      const wrapper = shallow(<InputField type='select' disabled={true} />)
    ...
    it('renders correctly with type=checkbox and checked', () => {
      const wrapper = shallow(<InputField type='checkbox' checked={true} />)
