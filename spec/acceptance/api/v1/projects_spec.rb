...
resource 'Projects' do
  ...
  get '/api/v1/projects/:id' do
    ...
    with_options with_example: true do
      ...
      response_field :accountId, 'project owner account id', type: :integer
      ...
      response_field :adminIds, 'array of admin account ids', type: :array, items: { type: :integer }
      ...
      response_field 'token[network]', 'token network', type: :string
