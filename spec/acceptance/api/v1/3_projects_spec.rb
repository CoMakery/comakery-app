...
resource 'III. Projects' do
  ...
  let!(:project) { create(:project, mission: active_whitelabel_mission, token: create(:comakery_security_token), account: create(:account, managed_mission: active_whitelabel_mission)) }
  let!(:project2) { create(:project, mission: active_whitelabel_mission, token: create(:comakery_security_token), account: create(:account, managed_mission: active_whitelabel_mission)) }
