...
describe Comakery::Eth::Tx::Erc20::SecurityToken::SetAllowGroupTransfer, vcr: true do
  let!(:security_token_set_allow_group_transfer) { build(:security_token_set_allow_group_transfer, blockchain_transaction: build(:blockchain_transaction_transfer_rule)) }
