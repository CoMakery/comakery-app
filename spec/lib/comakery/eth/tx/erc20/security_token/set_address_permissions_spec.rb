...
describe Comakery::Eth::Tx::Erc20::SecurityToken::SetAddressPermissions, vcr: true do
  let!(:security_token_set_address_permissions) { build(:security_token_set_address_permissions, blockchain_transaction: build(:blockchain_transaction_account_token_record)) }
