...
describe ECIES::Crypt do
  describe 'Encryption and decryption' do
    ...
    it 'Raises on unknown cipher or digest' do
      _key = OpenSSL::PKey::EC.new('secp256k1').generate_key
  ...
  describe '#kdf' do
    it 'derives keys correctly' do
      sha256_test_vectors = [
        ...
        %w[22518b10e70f2a3f243810ae3254139efbee04aa57c7af7d 75eef81aa3041e33b80971203d2c0c52 ],
        %w[7e335afa4b31d772c0635c7b0e06f26fcd781df947d2990a d65a4812733f8cdbcdfb4b2f4c191d87 ]
      ]
      ...
      sha256_test_vectors.each do |shared_secret, shared_info, expected_key|
        ...
        expect(computed_key.unpack('H*')).to eq expected_key.unpack('H*')
      end
    end
  ...
  describe '::calculate_public_key' do
    let(:private_key_hex) { '18E14A7B6A307F426A94F8114701E7C8E774E7F9A47E2C2035DB29A206321725' }
    let(:public_key_hex) { '0450863ad64a87ae8a2fe83c1af1a8403cb53f53e486d8511dad8a04887e5b23522cd470243453a299fa9e77237716103abc11a1df38855ed6f2ee187e9c582ba6' }

    context 'with public key passed' do
      subject { described_class.calculate_public_key described_class.public_key_from_hex(public_key_hex) }
    ...
    context 'with private key passed' do
      subject { described_class.calculate_public_key described_class.private_key_from_hex(private_key_hex) }
      it { is_expected.to eq(public_key_hex) }
    end
  end
end
