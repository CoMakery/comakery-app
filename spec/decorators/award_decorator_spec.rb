...
describe AwardDecorator do
  ...
  describe 'pay_data' do
    ...
    it 'returns payment data for ethereum_controller.js' do
      ...
      expect(data['ethereum-address']).to eq(eth_award.account.address_for_blockchain(eth_award.token._blockchain))
    ...
    it 'returns mint data for ethereum_controller.js' do
      ...
      expect(data['ethereum-address']).to eq(mint_award.account.address_for_blockchain(mint_award.token._blockchain))
    ...
    it 'returns burn data for ethereum_controller.js' do
      ...
      expect(data['ethereum-address']).to eq(burn_award.account.address_for_blockchain(burn_award.token._blockchain))
