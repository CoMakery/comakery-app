...
describe Reward do
  ...
  describe "#issuer_slack_user_name" do
    ...
    let!(:authentication) { create :authentication, account: issuer, slack_team_id: 'reds', slack_user_name: 'johnny', slack_first_name: nil, slack_last_name: nil }
  ...
  describe "#recipient_slack_user_name" do
    ...
    let!(:authentication) { create :authentication, account: recipient, slack_team_id: 'reds', slack_first_name: "Betty", slack_last_name: "Ross", slack_user_name: 'betty' }
    let!(:project) { create :project, slack_team_id: 'reds' }
    let!(:reward_type) { create :reward_type, project: project }
