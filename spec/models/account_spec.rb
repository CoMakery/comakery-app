...
describe Account do
  ...
  describe '#total_awards_earned' do
    ...
    let!(:award2) { create :award, account: contributor, issuer: project.account, award_type: award_type, amount: 10, quantity: 3.5 }
  ...
  describe '#percent_unpaid' do
    ...
    it 'handles divide by 0 risk' do
      create(:award, award_type: award_type, quantity: 1, amount: 1, account: account1, issuer: project.account)
      expect(account1.percent_unpaid(project)).to eq(100)
    end

    it 'handles two awardees' do
      create(:award, award_type: award_type, quantity: 1, amount: 1, account: account1, issuer: project.account)
      create(:award, award_type: award_type, quantity: 1, amount: 1, account: account2, issuer: project.account)
      expect(account1.percent_unpaid(project)).to eq(50)
    end

    it 'calculates only unpaid awards' do
      create(:award, award_type: award_type, quantity: 6, amount: 1, account: account1, issuer: project.account)
      create(:award, award_type: award_type, quantity: 6, amount: 1, account: account2, issuer: project.account)
      expect(account1.percent_unpaid(project)).to eq(50)
    end

    it 'returns 8 decimal point precision BigDecimal' do
      create(:award, award_type: award_type, quantity: 1, amount: 1, account: account1, issuer: project.account)
      create(:award, award_type: award_type, quantity: 2, amount: 1, account: account2, issuer: project.account)
  ...
  describe 'revenue' do
    ...
    let!(:award_type) { create(:award_type, project: project) }
    let!(:award1) { create :award, account: contributor, issuer: project.account, award_type: award_type, amount: 1, quantity: 50 }
    let!(:award2) { create :award, account: contributor, issuer: project.account, award_type: award_type, amount: 1, quantity: 50 }
