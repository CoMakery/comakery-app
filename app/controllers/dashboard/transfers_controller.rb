class Dashboard::TransfersController < ApplicationController
  ...
  private
    ...
    def set_transfers
      ...
      @transfers_all = @transfers_totals.includes(:blockchain_transactions, :token, :transfer_type, :project, award_type: [:project], issuer: [image_attachment: :blob], account: [:ore_id_account, :latest_verification, image_attachment: :blob])
      @filter_params = params[:q]&.to_unsafe_h
