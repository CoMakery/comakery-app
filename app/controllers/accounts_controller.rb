...
class AccountsController < ApplicationController
  ...
  def account_params
    result = params.require(:account).permit(:email, :ethereum_wallet, :qtum_wallet, :cardano_wallet, :bitcoin_wallet, :eos_wallet, :first_name, :last_name, :nickname, :country, :date_of_birth, :image, :password)
