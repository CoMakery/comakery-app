...
class ApplicationController < ActionController::Base
  ...
  def check_age
    redirect_to account_path, alert: 'Sorry, you must be 16 years or older to use this website' if current_account&.confirmed_and_valid? && current_account.age < 16 && controller_name != 'accounts'
  end
