class BetaSignupsController < ApplicationController
  ...
  def create
    if params[:commit] == Views::BetaSignups::New::OPT_IN_SUBMIT_BUTTON_TEXT
      ...
      redirect_to root_url, notice: "You have not been added to the beta waiting list. Check back to see new public #{Rails.application.config.project_name} projects!"
    end
  end
