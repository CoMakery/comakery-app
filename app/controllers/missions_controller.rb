  ...
  private
    ...
    def set_mission_props # rubocop:todo Metrics/CyclomaticComplexity
      projects = @mission
                   ...
                   .includes(:token, :project_interested, :award_types, :ready_award_types, :account,
                             admins: [:specialty], contributors_distinct: [:specialty])
        ...
        projects: projects.map do |project|
          {
            ...
            interested: project.project_interested.include?(current_account),
