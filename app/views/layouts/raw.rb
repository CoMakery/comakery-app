  ...
  def content
    ...
    html(lang: "en") {
      head {
        ...
        javascript_include_tag 'https://js.stripe.com/v2/'  # For Stripe’s fraud protection functionality, include Stripe.js on every page on your site, not just the checkout page
