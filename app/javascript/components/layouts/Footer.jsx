...
class Footer extends React.Component {
  render() {
    ...
    return (
      <React.Fragment>
        <div className={classnames} {...other} data-turbo-permanent>
          <div className="footer--logo">
            ...
            { isWhitelabel &&
              <div className="footer--logo__whitelabel">
                <img src={whitelabelLogoDark || whitelabelLogo} width="170px" />

                <div className="footer--logo__whitelabel--comakery">
                  Powered by
                  <Icon name="Logo-Footer.svg" width="130px" />
                </div>
              </div>
            }
          </div>
