...
exports.waitForNewTransaction = async function waitForNewTransaction(envs, hwRedis) {
  ...
  if (!enoughCoins) {
    ...
    return { status: "failed_before_getting_tx", transaction: {}, txHash: undefined }
  }
