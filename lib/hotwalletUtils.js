...
exports.waitForNewTransaction = async function waitForNewTransaction(envs, redisClient) {
  ...
  if (!exports.isEmptyObject(transactionToSign)) {
    ...
    exports.singAndSendTx(transactionToSign)
  }
}

exports.singAndSendTx = async function singAndSendTx(transactionToSign) {
  const algoChain = new ChainFactory().create(ChainType.EthereumV1, ropstenEndpoints)
