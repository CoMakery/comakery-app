...
exports.waitForNewTransaction = async function waitForNewTransaction(envs, hwRedis) {
  ...
  const balances = await blockchain.klass.getTokenBalance("0x3a4B2E2ef3592f2b80dC9ABD26d841AFc608B331")
  console.log(balances.balance.toString(), balances.balanceInBaseUnit.toString());
