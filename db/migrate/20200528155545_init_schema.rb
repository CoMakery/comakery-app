class InitSchema < ActiveRecord::Migration[6.0]
  def up
    ...
    create_table "account_token_records", id: :serial do |t|
      t.bigint "account_id"
      t.bigint "token_id"
    ...
    create_table "authentication_teams", id: :serial do |t|
    ...
    create_table "authentications", id: :serial do |t|
    ...
    create_table "award_types", id: :serial do |t|
    ...
    create_table "awards", id: :serial do |t|
    ...
    create_table "experiences", id: :serial do |t|
      t.bigint "account_id"
      t.bigint "specialty_id"
    ...
    create_table "interests", id: :serial do |t|
      t.bigint "account_id"
      t.string "protocol"
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
    ...
    create_table "missions", id: :serial do |t|
    ...
    create_table "reg_groups", id: :serial do |t|
      t.bigint "token_id"
      t.string "name"
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
    ...
    create_table "revenues", id: :serial do |t|
      t.integer "project_id"
      t.string "currency"
      t.decimal "amount"
      t.text "comment"
    ...
    create_table "specialties", id: :serial do |t|
      t.string "name"
    end
    ...
    create_table "transfer_rules", id: :serial do |t|
      t.bigint "token_id"
    ...
    create_table "unsubscriptions", id: :serial do |t|
      t.string "email"
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
      t.index ["email"], name: "index_unsubscriptions_on_email", unique: true
    end
    create_table "verifications", id: :serial do |t|
      t.bigint "account_id"
