...
ActiveRecord::Schema.define(version: 2020_10_16_151114) do
  ...
  create_table "ore_ids", force: :cascade do |t|
    t.string "account_name"
    t.bigint "account_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["account_id"], name: "index_ore_ids_on_account_id"
  end
  ...
  create_table "wallets", force: :cascade do |t|
    ...
    t.index ["ore_id_id"], name: "index_wallets_on_ore_id_id"
  end
  ...
  add_foreign_key "ore_ids", "accounts"
  ...
  add_foreign_key "wallets", "ore_ids"
end
